      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $no = 1;
                      $dev = "DEVICE 1";
            $sql = "SELECT * FROM datakendaran DESC LIMIT 0,20";
            ...
            echo "<tr><td>" . $no++. "</td><td>" . $row["mac"] . "</td><td>"
            . $row["reading_time"]. "</td><td>". $row["temp"]. "</td><td>"
            . $row["humid"]. "</td><td>". $row["pm25"]. "</td><td>". $row["pm10"]. "</td></tr>";
            }
            }
          ?>
                    </tbody>
