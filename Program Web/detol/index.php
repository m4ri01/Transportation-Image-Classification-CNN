...
<body>
	<img src="images/bg.png" width="100%" style="z-index: -1;position: absolute;opacity: 50%;">
	<div class="limiter">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="proses_login.php" method="post">
					<span class="login100-form-title">
						<img src="images/icons.png" width="20%" height="20%"><b style="margin-left: 10%; color: #FFF">DETOL</b>
					</span>
